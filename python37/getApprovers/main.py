...
def getApprovers(request):
    ...
    for i in range (len(recepient_Name)):
            ...
            myUuid = str(uuidOne)
            if links[0] == "<a href=></a>" :
                body_htmlpage1 = ('Hi,<br /><br />Task has been assigned to you.<br></br>' 
                'Approve or Reject the Task using below buttons :<br/><br></br></br><a href='
                ...
                body_htmlpage1 = ('Hi,<br /><br />Task has been assigned to you.<br></br> Please go through the links '
                    ...
                    ' and Approve or Reject the Task using below buttons :<br/><br></br></br>' 
                    '<a href='
                    +approve_reject[0]["ApproverLink"]+'?correlationKey='
                )
            body_htmlpage2 = (
