...
# print(approve_reject[0]["ApproverLink"])
def getApprovers(request):
     # for i in range len(recepient_Name):
        ...
        for i in range (len(recepient_Name)):
                ...
                body_htmlpage1 = "Hi,<br /><br />Task has been assigned to you.<br></br> Please go through the links <a href= https://storage.cloud.google.com/attached-mail-file/myfileGCP0>PDF File</a> and <a href= https://storage.cloud.google.com/attached-mail-file/myfileGCP1>XLS File</a> and Approve or Reject the Task using below buttons :<br/><br></br></br> <a href="+approve_reject[0]["ApproverLink"]+"?correlationKey="
                body_htmlpage2 = "><button>Approve</button></a> <a href="+approve_reject[0]["ApproverLink"]+"?correlationKey="
                body_htmlpage3 = """><button style="margin-left: 20px">Reject</button></a><br/><br />Thanks,<br />Support Team"""
                body_htmlpage = body_htmlpage1+myUuid+"t"+body_htmlpage2+myUuid+"f"+body_htmlpage3
